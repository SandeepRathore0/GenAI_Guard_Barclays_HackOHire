...
class URLFeatureExtractor:
    ...
    def extract_model_features(self):
        # We purposefully removed the author's catastrophic short circuit here 
        # so the XGBoost model STILL processes structural URLs even if the website is fake/offline!
